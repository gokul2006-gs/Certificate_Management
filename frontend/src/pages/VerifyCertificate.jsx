...
function VerifyCertificate() {
  ...
  useEffect(() => {
    api
      .get(`/certificates/verify/${studentId}`, { params: token ? { token } : {}, skipAuthRedirect: true })
            ...
            <aside className="min-w-0 space-y-4">
              ...
              <div className="rounded-2xl border border-slate-200/60 bg-white p-5 shadow-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-md">
                ...
                <div className="divide-y divide-slate-100">
                  ...
                  <VerifyField icon={CalendarDays} label="Expires" value={data.expires_at ? formatDate(data.expires_at) : "No expiry"} />
                </div>
              </div>
