        ...
        <aside className="glass-panel rounded-2xl p-5 shadow-sm sm:p-6">
          ...
          {certificate ? (
            <div className="text-center">
              ...
              {certificate.qr && (
                <div onClick={() => alert("ðŸ“± Please scan the QR code using your camera or QR scanner app to verify the certificate. Do not click on it!")} className="mx-auto block w-full max-w-[240px] rounded-2xl border border-slate-100 bg-white p-4 shadow-md transition duration-300 hover:scale-[1.05] hover:shadow-lg cursor-pointer">
                  <img
                    src={certificate.qr}
