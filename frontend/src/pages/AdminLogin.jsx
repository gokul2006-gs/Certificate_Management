		...
		<main className="relative grid min-h-screen place-items-center overflow-hidden px-4 py-16 bg-slate-50/30">
			<div className="w-full max-w-md animate-scale-in">
				...
				<form onSubmit={handleLogin} className="glass-panel w-full rounded-2xl p-8 shadow-xl transition-all duration-500 border border-white/60">
					...
					<label className="mb-4 block" htmlFor="admin-username">
						...
						<input
							...
							className="normal-case w-full rounded-xl border border-slate-200 bg-white/50 px-4 py-3 text-sm font-medium text-slate-800 outline-none focus:border-primary-500 focus:bg-white transition-all duration-300"
							placeholder="admin"
						/>
					</label>

					<label className="mb-6 block" htmlFor="admin-password">
