...
MIDDLEWARE = [
    ...
    'config.api_auth_middleware.RequireApiAuthenticationMiddleware',
...
MONGODB_FILE_BUCKET = os.environ.get("MONGODB_FILE_BUCKET", "certificate_files")
STORAGES = {
    "default": {
        "BACKEND": "config.mongo_storage.MongoGridFSStorage",
    },
    "staticfiles": {
