          ...
          <label className="mb-6 block">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-white/50 px-4 py-3 text-sm font-medium text-slate-800 pr-12 outline-none focus:border-primary-500 focus:bg-white focus:ring-4 focus:ring-primary-500/10 hover:scale-[1.01] focus:scale-[1.01] transition-all duration-300"
              />
              <button
                type="button"
